      ...
      function a(a, t) {
          ...
          var y = function() {
                  var a = e('<table class="buttonpane"/>'),
                      t = e("<tr/>");
                  return f(t, i.CLEAR, null, o.clear, "clear"), f(t, i.TODAY, null, o.today, "today"), f(t, i.OK, null, o.dok, "okk"), t.appendTo(a), a
              }(),
              E = l.VIEWMODE;
          switch (t.viewMode) {
              case E.YM:
              ...
              case E.HMS:
                  w(d, u, t.viewMode), T.append(d.show()),
                      function(a) {
                          var t = e("<table/>"),
                              n = e("<tr/>").appendTo(t);
                          f(n, i.CLEAR, 1, o.clear, "clear"), f(n, i.CURRENT, 1, o.current, "current"), f(n, i.OK, 1, o.dok, "okk"), t.appendTo(a)
                      }(T);
                  break;
              case E.YMD:
