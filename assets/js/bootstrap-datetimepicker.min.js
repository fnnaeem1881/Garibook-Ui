! function(e) {
      ...
      function a(a, t) {
          var n, s, d, r = {},
              ...
              Y = function(e, a) {
                  if (a) {
                      ...
                      for (var Y = e.find("tbody").children().eq(0), b = 0; b < 6 && Y.length; b++) {
          ...
          var y = function() {
                  var a = e('<table class="buttonpane"/>'),
                      t = e("<tr/>");
                  return f(t, i.CLEAR, null, o.clear, "Reset"), f(t, i.TODAY, null, o.today, "today"), f(t, i.OK, null, o.dok, "okk"), t.appendTo(a), a
              }(),
              E = l.VIEWMODE;
          switch (t.viewMode) {
              case E.YM:
              ...
              case E.HMS:
                  w(d, u, t.viewMode), T.append(d.show()),
                      function(a) {
                          var t = e("<table/>"),
                              n = e("<tr/>").appendTo(t);
                          f(n, i.CLEAR, 1, o.clear, "Reset"), f(n, i.CURRENT, 1, o.current, "current"), f(n, i.OK, 1, o.dok, "okk"), t.appendTo(a)
                      }(T);
                  break;
              case E.YMD:
          ...
          return function() {
              var a = function(a) {
                  ...
                  if (!p.data("disabled") && 0 !== p.length && v)
                      ...
                      case o.dok:
                        //alert('asd');
                       // document.getElementsByClassName("perfect-datetimepicker").style.color = "blue !important";
                        // const collection = document.getElementsByClassName("example");
                        $('.perfect-datetimepicker').addClass('perfect-datetimepicker-remove');
      ...
      e.fn.datetimepicker = function(t) {
          ...
          I18N: {
              zh: {
                  SDN: ["æ—¥", "ä¸€", "äºŒ", "ä¸‰", "å››", "äº”", "å…­"],
                  MN: ["ä¸€æœˆ", "äºŒæœˆ", "ä¸‰æœˆ", "å››æœˆ", "äº”æœˆ", "å…­æœˆ", "ä¸ƒæœˆ", "å…«æœˆ", "ä¹æœˆ", "åæœˆ", "åä¸€æœˆ", "åäºŒæœˆ"],
                  DN: ["æ˜ŸæœŸæ—¥", "æ˜ŸæœŸä¸€", "æ˜ŸæœŸäºŒ", "æ˜ŸæœŸä¸‰", "æ˜ŸæœŸå››", "æ˜ŸæœŸäº”", "æ˜ŸæœŸå…­"],
                  CALENDAR: "æ—¥åŽ†",
                  CLEAR: "æ¸…ç©º",
                  TODAY: "ä»Šå¤©",
                  OK: "ç¡®å®š",
